...
C     ******************************************************************
      ...
      parameter (nh=nall/2)
C     >>> only for bicgg5: correction to accuracy
      parameter (acc=ACCURACY1*0.1,maxits=2000,max_limit=100)
C     ------------------------------------------------------------------
...
C     -----------------------------------------------------------------
      ...
      do i = 1, nh
	b(i) = b(i) + bb(i)
c        x(i) = 0.0d0   !!! lead to inversion errors !!!
        x(i) = 1.0d0 / dble(nall)
      end do
