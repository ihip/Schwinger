...
C     ******************************************************************
C     **                   **                                         **
C     ** CHECKSIGMA        **   I. Hip, 2022-06-16                    **
C     ** derived from:     **   Last modified: 2022-06-16             **
C     ** MASPCOLL v3       **                                         **
C     ******************************************************************
C     ...
C     ******************************************************************
	...
	write(*, *)
	write(*, *) 'Check sigma (Hip, 2022-06-16)'
	write(*, *) '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
	write(*, *)
...
c	>>> sigma computed from trace of the inverse overlap operator
	real*8 sigtr
...
c     >>> compute sigma from trace [Gattringer/Lang eq. (7.66)]
	  sigtr = (pbp - ntime * nspace) / ((ntime * nspace) *
     &  (1.0d0 - 0.5d0 * fmass))

c     >>> compare the sigmas
	  write(*, *) i, pbp, sigtr, sigma, dabs(sigtr - sigma)
