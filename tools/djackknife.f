C     ******************************************************************
      subroutine djackknife(nmeas, jkblocks, c, ac, ab, var_naiv, var)
C     ******************************************************************
C     **                   **                                         **
C     **  DJACKKNIFE       **   I. Hip, 20 Jun 96                     **
C     **                   **   Last modified: Hip, 2022-04-16        **
C     ******************************************************************
C     - Hip, 2022-04-16: original jackknife adjusted to double precision
C     ******************************************************************
